...
Tables.registerTable = function (options) {
  ...
  if ('classes' in options) Tables.registered[options.table_id].classes = options.classes;
  Tables.registered[options.table_id].hard_limit = ('hard_limit' in options) ? options.hard_limit : Number.MAX_VALUE;
